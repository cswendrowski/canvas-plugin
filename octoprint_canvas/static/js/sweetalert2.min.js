!(function(e, t) {
  ...
  var t = "SweetAlert2:",
    ...
    j = '\n <div aria-labelledby="'
      ...
      .concat(D.icon, " ")
      .concat(g.question, '">\n       <span class="')
      .concat(D["icon-text"], '">?</span>\n      </div>\n     <div class="')
      .concat(D.icon, " ")
      .concat(g.warning, '">\n       <span class="')
      .concat(D["icon-text"], '">!</span>\n      </div>\n     <div class="')
      .concat(D.icon, " ")
      .concat(g.info, '">\n       <span class="')
      .concat(D["icon-text"], '">i</span>\n      </div>\n     <div class="')
      .concat(D.icon, " ")
      .concat(
        g.success,
      ...
      .concat(D.close, '">Ã—</button>\n   </div>\n   <div class="')
      .concat(D.content, '">\n     <div id="')
      .concat(D.content, '"></div>\n     <input class="')
    ...
    X = function(e) {
      ...
      if (
        (t &&
          ...
          z([document.documentElement, document.body], [D["no-backdrop"], D["toast-shown"], D["has-column"]])),
        !M())
      ) {
        var n = document.createElement("div");
        (n.className = D.container), (n.innerHTML = j);
        ...
        var i,
          ...
          s = W(a, D.input),
          c = W(a, D.file),
          u = a.querySelector(".".concat(D.range, " input")),
          l = a.querySelector(".".concat(D.range, " output")),
          d = W(a, D.select),
          p = a.querySelector(".".concat(D.checkbox, " input")),
          f = W(a, D.textarea);
        r.setAttribute("role", e.toast ? "alert" : "dialog"),
          ...
          "rtl" === window.getComputedStyle(o).direction && N(w(), D.rtl);
        var m = function(e) {
    ...
    te = function(e) {
      var t = Q(),
        ...
        o = Z();
      if (
        (e.showConfirmButton || e.showCancelButton ? U(t) : K(t),
        e.showCancelButton ? (o.style.display = "inline-block") : K(o),
        e.showConfirmButton ? n.style.removeProperty("display") : K(n),
        ...
        N(n, e.confirmButtonClass),
        (o.className = D.cancel),
        N(o, e.cancelButtonClass),
        e.buttonsStyling)
      ) {
        N([n, o], D.styled),
      ...
      i.progressSteps && i.progressSteps.length
        ? (U(r),
          ...
          i.progressSteps.forEach(function(e, t) {
            ...
            if (
              (N(n, D.progresscircle),
              (n.innerHTML = e),
              t === a && N(n, D.activeprogressstep),
              r.appendChild(n),
    ...
    ae = function(e) {
      ...
      e.titleText
        ...
        : e.title && ("string" == typeof e.title && (e.title = e.title.split("\n").join("<br />")), G(e.title, t));
    },
    se = function() {
        ...
        var i = function() {
          T()
            ...
            z(
              ...
              [D.shown, D["height-auto"], D["no-backdrop"], D["toast-shown"], D["toast-column"]]
            ),
            L() &&
              (null !== b.previousBodyPadding &&
                ((document.body.style.paddingRight = b.previousBodyPadding), (b.previousBodyPadding = null)),
              (function() {
  ...
  var me = {
    ...
    ye = function(e) {
      for (var t in e)
        be(t) || q('Unknown parameter "'.concat(t, '"')),
          e.toast && -1 !== ge.indexOf(t) && q('The parameter "'.concat(t, '" is incompatible with toasts')),
  ...
  function Oe() {
    ...
    e.showConfirmButton || (K(t.confirmButton), e.showCancelButton || K(t.actions)),
      z([t.popup, t.actions], D.loading),
  ...
  var je = function(e) {
    ...
    null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n),
      e.animation ? (N(n, D.show), N(t, D.fade), z(n, D.hide)) : z(n, D.fade),
      U(n),
      (t.style.overflowY = "hidden"),
      ee && !v(n, D.noanimation)
        ? n.addEventListener(ee, function e() {
            n.removeEventListener(ee, e), (t.style.overflowY = "auto");
          })
        : (t.style.overflowY = "auto"),
      N([document.documentElement, document.body, t], D.shown),
      e.heightAuto && e.backdrop && !e.toast && N([document.documentElement, document.body], D["height-auto"]),
      L() &&
        (se(),
        (function() {
      ...
      T() || le.previousActiveElement || (le.previousActiveElement = document.activeElement),
      null !== e.onOpen &&
    ...
    qe = Object.freeze({
      ...
      getInput: function(e) {
        ...
        switch (e) {
          ...
          case "radio":
            return (
              n.popup.querySelector(".".concat(D.radio, " input:checked")) ||
              n.popup.querySelector(".".concat(D.radio, " input:first-child"))
            );
          case "range":
        ...
        !(function(t) {
          ...
          if (
            ...
            "string" == typeof t.backdrop
              ...
              : t.backdrop || N([document.documentElement, document.body], D["no-backdrop"]),
            !t.backdrop &&
              t.allowOutsideClick &&
              q('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
            t.position in D
              ? N(s, D[t.position])
              : (q('The "position" parameter is not valid, defaulting to "center"'), N(s, D.center)),
            t.grow && "string" == typeof t.grow)
          ) {
            var l = "grow-" + t.grow;
            l in D && N(s, D[l]);
          }
          t.showCloseButton ? (c.setAttribute("aria-label", t.closeButtonAriaLabel), U(c)) : K(c),
            (e.className = D.popup),
            t.toast ? (N([document.documentElement, document.body], D["toast-shown"]), N(e, D.toast)) : N(e, D.modal),
            t.customClass && N(e, t.customClass),
            re(t),
            oe(t),
            ie(t),
            te(t),
            G(t.footer, u),
            !0 === t.animation ? z(e, D.noanimation) : N(e, D.noanimation),
        ...
        return new Promise(function(t, n) {
          ...
          for (
            var l = function(t) {
              ...
              i = M.popup.querySelectorAll("button"),
              r = 0;
            r < i.length;
            r++
          )
          ...
          T.reverseButtons
            ? M.confirmButton.parentNode.insertBefore(M.cancelButton, M.confirmButton)
            : M.confirmButton.parentNode.insertBefore(M.confirmButton, M.cancelButton);
          var s = function(e, t) {
            for (var n = J(T.focusCancel), o = 0; o < n.length; o++)
          ...
          le.keydownHandlerAdded &&
            ...
            T.toast ||
                ...
                return (function(e, t) {
                  if ((t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing))
                    if ("Tab" === e.key) {
                      ...
                      -1 !==
                      ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key)
                        ? document.activeElement === M.confirmButton && F(M.cancelButton)
                          ? M.cancelButton.focus()
                          : document.activeElement === M.cancelButton && F(M.confirmButton) && M.confirmButton.focus()
                        : ("Escape" !== e.key && "Esc" !== e.key) ||
                          !0 !== I(t.allowEscapeKey) ||
                          (e.preventDefault(), c(j.DismissReason.esc));
              ...
              (le.keydownTarget = T.keydownListenerCapture ? window : M.popup),
              (le.keydownListenerCapture = T.keydownListenerCapture),
            ...
            T.toast && (T.input || T.footer || T.showCloseButton)
              ? N(document.body, D["toast-column"])
              : z(document.body, D["toast-column"]);
          for (
            var d, p, f = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], m = 0;
            m < f.length;
            m++
          ) {
            var h = D[f[m]],
          ...
          switch (T.input) {
            ...
            case "tel":
            case "url":
              (d = W(M.content, D.input)),
                "string" == typeof T.inputValue || "number" == typeof T.inputValue
                  ? (d.value = T.inputValue)
                  : q(
                      'Unexpected type of inputValue! Expected "string" or "number", got "'.concat(V(T.inputValue), '"')
                    ),
            ...
            case "checkbox":
              ...
              (P.type = "checkbox"),
                ...
                (S.querySelector("span").innerHTML = T.inputPlaceholder),
                U(S);
              break;
            case "textarea":
          ...
          if ("select" === T.input || "radio" === T.input) {
            ...
            H(T.inputOptions)
              ...
              : "object" === V(T.inputOptions)
                ? E(T.inputOptions)
                : R("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(V(T.inputOptions)));
          } else
          ...
          je(T),
            T.toast ||
              (I(T.allowEnterKey)
                ? T.focusCancel && F(M.cancelButton)
                  ? M.cancelButton.focus()
                  : T.focusConfirm && F(M.confirmButton)
  ...
  var Ie,
    ...
    De = fe(
      ...
      "undefined" != typeof window && "object" === V(window._swalDefaults) && He.setDefaults(window._swalDefaults),
      He)
    );
